...
public sealed class Constants
{
    ...
    public const string FrontendTranslationsRootKey = "Frontend";
    public const string CharlieTangoAuthors = "Casper Korsgaard";
    public const string CharlieTangoUrl = "https://www.charlietango.dk/";
    public const string CharlieTangoEmail = "cko@charlietango.dk";
}

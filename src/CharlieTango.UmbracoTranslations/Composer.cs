...
public class Composer : IComposer
{
    public void Compose(IUmbracoBuilder builder)
    {
        ...
        builder.Services.Configure<SwaggerGenOptions>(opt =>
        {
            ...
            {
                Title = "Charlie Tango Umbraco Translations Backoffice API",
                Version = "1.0",
            ...
            opt.OperationFilter<CharlieTangoUmbracoTranslationsOperationSecurityFilter>();
        });
    }

    public class CharlieTangoUmbracoTranslationsOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
    {
    ...
    public class CustomOperationHandler : OperationIdHandler
    {
        ...
        {
            return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("CharlieTango.UmbracoTranslations.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
        }
